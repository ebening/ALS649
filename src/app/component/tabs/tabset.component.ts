import { Component, HostBinding, Input, OnDestroy, OnInit, style } from '@angular/core';
...
@Component({
  selector: 'tabset',
  template: `
    <ul class="nav nav-tabs" [class.navbar-right]="rightNav" [ngClass]="classMap" (click)="$event.preventDefault()">
